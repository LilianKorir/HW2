...
public class PlayThatTune {
     ...
     * Main wrapper method
     *
     * It prompts the user to select a text file (containing audio sample values)
     * and then plays it by building an appropriate Guitar object.
     *
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        FileNameExtensionFilter filter = new FileNameExtensionFilter("music files", "txt");
        ...
        while (input.hasNextInt()) {
            ...
            int target = time + (int) Math.round(duration * StdAudio.SAMPLE_RATE);
